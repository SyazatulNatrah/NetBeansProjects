 ...
 */
package finalprojecta182;

import java.util.*;
public class FinalProjectA182 {
...
static int addOrder(int[] lists, int count){
  if (count < lists.length){ 
            ...
            System.out.println("9. Religion (180 Prayers): RM15");
            System.out.println("10. 100 Essays: RM7");
...
static int deleteOrder(int [] lists,int count){
  ...
  for ( i=0; i<total;i++)
   ...
   public static void naming(){ //Method to allocate all name to array
		Name[0]= "Oxford Dictionary: RM50.00";
		Name[1]= "Children - Books: RM12.00";
		Name[2]= "Cookbook: RM10.00";
		Name[3]= "Comics: RM5.00";
		Name[4]= "Novel: RM19.00";
		...
		Name[9]= "100 Essays: RM7.00";
                
   }           
    public static void outputPrice(int [] lists )
   {
    
                double totalPrice=0.0,pay;
                double price [] = {50.00,12.00,10.00,5.00,9.00,55.00,5.00,9.00,15.00,7.00};
                for (int i=0; i<price.length; i++){
                    totalPrice = lists[i]*price[i];
                }
               
     System.out.printf("%nGrand total: %.2f%n",totalPrice);
